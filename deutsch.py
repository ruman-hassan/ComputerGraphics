...
train_file = os.path.join(dataset_folder, 'de-DE-train.jsonl')
dev_file = os.path.join(dataset_folder, 'de-DE-dev.jsonl')
test_file = os.path.join(dataset_folder, 'de-DE-test.jsonl')
